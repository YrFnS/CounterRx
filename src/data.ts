...
export interface Category { id: CategoryId; label: string; dot: string; }

export const CATEGORIES: Category[] = [
  { id: "antibiotics", label: "Antibiotics", dot: "#3b8668" },
  { id: "pain",        label: "Pain Relief", dot: "#c24a2e" },
  { id: "coldflu",     label: "Cold & Flu",  dot: "#5b8fc9" },
  { id: "vitamins",    label: "Vitamins",    dot: "#e0a63c" },
  { id: "diabetes",    label: "Diabetes",    dot: "#7b63c4" },
  { id: "cardio",      label: "Cardio",      dot: "#d1567a" },
  { id: "derma",       label: "Skin Care",   dot: "#4fa3a5" },
  { id: "devices",     label: "Devices",     dot: "#5c6b66" },
  { id: "firstaid",    label: "First Aid",   dot: "#8a9a3b" },
  { id: "baby",        label: "Baby & Mom",  dot: "#d98bb0" },
];
...
export interface Product {
  ...
  rx: boolean; batch: string; expiry: string; // ISO date
  supplier: string;
}

export interface TxLine { productId: string; name: string; form: string; qty: number; price: number; rx: boolean; }
...
function p(
  ...
  return {
    ...
    name, generic, brand, category, form, price, cost, stock, reorderLevel, rx, batch,
    expiry: iso(Date.now() + expDays * day), supplier,
  };
}
...
export function makeProducts(now: number): Product[] {
  void now;
  return [
    p("amx500", "Amoxicillin 500mg", "Amoxicillin trihydrate", "Novex Pharma", "antibiotics", "Capsule · strip of 10", 8.4, 4.9, 132, 40, true, "AMX-24C11", 240, "MediSource Ltd"),
    ...
    p("cipro500", "Ciprofloxacin 500mg", "Ciprofloxacin HCl", "Ciprolon", "antibiotics", "Tablet · strip of 10", 9.6, 5.4, 64, 25, true, "CIP-24A19", 310, "PharmaLine Co"),
    p("ibu400", "Ibuprofen 400mg", "Ibuprofen", "Brufen", "pain", "Tablet · strip of 20", 3.2, 1.4, 260, 60, false, "IBU-25D02", 420, "PharmaLine Co"),
    p("pcm500", "Paracetamol 500mg", "Acetaminophen", "Calpol", "pain", "Tablet · strip of 15", 1.8, 0.7, 420, 100, false, "PCM-25E14", 500, "Apex Distributors"),
    ...
    p("cfsyrup", "Cough Syrup DM", "Dextromethorphan 15mg/5ml", "Benylin", "coldflu", "Syrup · 100ml bottle", 6.5, 3.6, 46, 20, false, "BEN-25C21", 205, "Apex Distributors"),
    ...
    p("met500", "Metformin 500mg", "Metformin HCl", "Glucophage", "diabetes", "Tablet · strip of 15", 4.9, 2.2, 210, 60, true, "MET-25B25", 290, "MediSource Ltd"),
    ...
    p("insg", "Insulin Glargine", "Insulin glargine 100IU/ml", "Lantus", "diabetes", "SoloStar pen · 3ml", 46.5, 33.0, 12, 10, true, "LNT-24K02", 44, "ColdChain Direct"),
    ...
    p("omz20", "Omeprazole 20mg", "Omeprazole", "Losec", "derma", "Capsule · strip of 14", 6.9, 3.4, 92, 30, false, "OMZ-25E07", 250, "PharmaLine Co"),
    ...
    p("salb", "Salbutamol Inhaler", "Salbutamol 100mcg", "Ventolin", "coldflu", "Inhaler · 200 doses", 14.8, 9.1, 22, 10, true, "VNT-25I06", 190, "ColdChain Direct"),
