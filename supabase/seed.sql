...
-- Demo PINs printed by the lock screen: S-001 3333 · S-002 2222 · S-003 1111 · S-004 4444 · S-005 5555 · S-006 6666.
...
insert into public.staff (id, name, role, pin_hash, initials, active) values
  ...
  ('S-006','K. Asante','manager','10fc72a7238deed8d23fe4f69584a563bd5d4db7621da3bd84c9d9fd020b101e','KA',true)
...
values
  ...
  ('00000000-0000-0000-0000-000000000000','00000000-0000-0000-0000-000000000006','authenticated','authenticated','s006@counterrx.local',crypt('CRxS0066666',gen_salt('bf')),now(),'{"provider":"email","providers":["email"]}','{}',now(),now(),now(),false,false)
...
values
  ...
  ('00000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000006','{"sub":"00000000-0000-0000-0000-000000000006","email":"s006@counterrx.local","email_verified":true,"phone_verified":false}','email',now(),now(),now(),'00000000-0000-0000-0000-000000000006')
...
insert into public.profiles (id, staff_id, role) values
  ...
  ('00000000-0000-0000-0000-000000000006','S-006','manager')
